...
namespace Shop.Web.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            return View(await _context.Produtcs.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var product = await _context.Produtcs
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var product = await _context.Produtcs.FindAsync(id);
            if (product == null)
            {
                return NotFound();
            }
        ...
        {
            var product = await _context.Produtcs.FindAsync(id);
            _context.Produtcs.Remove(product);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.Produtcs.Any(e => e.Id == id);
        }
    }
}
